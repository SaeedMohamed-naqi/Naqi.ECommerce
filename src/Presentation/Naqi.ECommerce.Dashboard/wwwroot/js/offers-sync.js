// src/Presentation/Naqi.ECommerce.Dashboard/wwwroot/js/offers-sync.js

(function () {
    "use strict";

    document.addEventListener("DOMContentLoaded", function () {
        const btn = document.getElementById("sync-offers-btn");
        const icon = document.getElementById("sync-offers-icon");
        const label = document.getElementById("sync-offers-label");
        if (!btn) return;
        ...
        btn.addEventListener("click", async function () {
            ...
            try {
                ...
                const response = await fetch("/Offers/Sync", {
                    method: "POST",
