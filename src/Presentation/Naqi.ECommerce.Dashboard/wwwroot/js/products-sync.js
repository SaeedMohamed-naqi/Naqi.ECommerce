// src/Presentation/Naqi.ECommerce.Dashboard/wwwroot/js/products-sync.js
...
(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const successTextTemplate = btn.dataset.successText; // e.g. "{fetched} fetched, {created} created, {updated} updated"
            ...
            try {
                ...
                if (data.success) {
                    ...
                    const text = successTextTemplate
                        .replace("{fetched}", summary.totalFetched)
